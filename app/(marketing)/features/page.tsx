import { Shield, LineChartIcon as ChartLine, Settings, Cpu, BarChart3, Bell } from 'lucide-react'
  ...
  return (
    <section>
      ...
      <p className="mb-10 text-slate-300">
        Powerful capabilities to help you trade and manage packages on {BRAND_NAME}.
      </p>
